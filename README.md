...
SQL is the software used to manage relational databases.

- [x] Why do tables need a `primary key`?

Primary keys are used to distinguish between duplicate entries in a db.

- [x] What is the name given to a table column that references the primary key on another table.

Foreign keys, which are a type of table field used for creating links between tables.
